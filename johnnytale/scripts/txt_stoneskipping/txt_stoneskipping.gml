function txt_stoneskipping() {
	...
	txt("It looks like they're 'skipping stones'...", JOHNNY.),
	txt("Have you ever done it, Gyro? 'Skip stones' like that?", JOHNNY.),
	
	txt("No...", GYRO.),
	
	txt("...", JOHNNY.),
	
	txt("...Let's try it.", GYRO.),
	
	txt("Huh? Shouldn't we keep moving?", JOHNNY.),
	
	txt("Call this 'practice'."
	txt("For a game like that, you need a 'flat stone'... am I right?"
	txt("I want you to use your 'spin' to create a 'perfect stone' for tossing."
	...
	txt("We'll both aim to get a stone over to those kids.", GYRO.),
	txt("That will determine the 'winner'.", GYRO.),
	
	txt("Sure... what do we win?", JOHNNY.),
	
	txt("Fifty million dollars, heh.", GYRO.),
	
	txt("Yeah, yeah...", JOHNNY.),
	...
	txt("Obviously, we won't be 'spinning' the rocks as we throw them.", GYRO.),
	...
	txt("Oh, oh!?", GYRO.),
	txt("Johnny, you got a good one there!?", GYRO.),
	
	txt("Yeah, yeah!", JOHNNY.),
	txt("I don't know what it is, but this stone feels perfect! I didn't even have to shave it down!", JOHNNY.),
	
	txt("Go on, throw it!", GYRO.),
	...
	txt("...Huh?", JOHNNY.),
	txt("Did I... do that?", JOHNNY.),
	
	txt("Gyro fights to keep his posture relaxed, but his eyes have gone sharp."),
	txt("Facing Johnny, he asks,"),
	
	txt("...Johnny. Tell me right now.", GYRO.),
	txt("You didn't 'spin' that stone, did you?", GYRO.),
	txt("I need to be absolutely certain...", GYRO.),
	
	txt("No... I didn't.", JOHNNY.),
	txt("I swear, I didn't!", JOHNNY.),
	txt("Gyro, what's going on!?", JOHNNY.),
