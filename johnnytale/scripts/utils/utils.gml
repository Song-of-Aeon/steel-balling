...
/*exception_unhandled_handler(function(ex){
	...
	switch irandom(3) {
		...
		case 1:
			...
			break;
		case 2:
			amongus+="heh... is that all you got?";
			amongus+="\nbetter luck next time kid... you're just not on my level.";
			break;
		case 3:
			amongus+="ZOMG u did NOT just do taht!!1";
			amongus+="\norz i rly thought u were gunna make it to teh end X_X";
			break;
	}
	amongus+="\n";
	amongus+="\n"+string(ex.message);
	...
	//show_message(room);
	//show_message(instance_number(all))
	//js("debugger"); //putting a debugger here is nearly useless lmao
	//game_save("test");
	//surface_save(global.surfaces.map,"balls.png");
	return 0;
});*/
